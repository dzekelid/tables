...
- name: Azure Virtual Network API Route Tables List All
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tables/master/_listings/azure-virtual-network/subscriptions-subscriptionid-providers-microsoft-network-routetables-get-postman.md
x-common:
