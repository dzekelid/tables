...
- name: Azure Virtual Network API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/tables/master/_listings/azure-virtual-network/subscriptions-subscriptionid-providers-microsoft-network-routetables-get.md
x-common:
